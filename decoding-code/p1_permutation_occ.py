...
def process_single_subject(single_subject, eeg_f_data, eeg_inf_data, behav_f_data, behav_inf_data):
    ...
    # np.save(f"phase1_occ_permutations/{single_subject}.npy", perm)
    np.save(f"phase1_occ_permutations_f/{single_subject}.npy", perm_f)
    np.save(f"phase1_occ_permutations_inf/{single_subject}.npy", perm_inf)

    print(f"Finished and saved results for subject: {single_subject}")

if __name__ == "__main__":
    subjects = ['37', '38', '39', '40', '41', '42', '44', '45',
                '46', '47', '48']
    
    # Create output directories if they don't exist
    # os.makedirs("phase1_occ_permutations", exist_ok=True)
    os.makedirs("phase1_occ_permutations_f", exist_ok=True)
    os.makedirs("phase1_occ_permutations_inf", exist_ok=True)
